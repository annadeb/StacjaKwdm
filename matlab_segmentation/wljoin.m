...
%FIXME ? progowanie na bardzo niskim poziomie -> z wyj¹tkiem trybu direct
...
switch (viewing)
    ...
    case 'compare', 
        ...
        %trzeba podwoiæ te¿ maskê...
        if (strcmp(masking, 'direct')) %wtedy zerami, ¿eby nie zak³óciæ
